...
define ("ACTION_GET_RCR_PERSONAL_ANALYZE", "getRCRPersonalAnalyze");
define ("ACTION_GET_RCR_PERSONAL_ANALYZE_PARAM_TOURNAMENT_ID", "tournamentId");
define ("ACTION_GET_RCR_PERSONAL_ANALYZE_PARAM_PLAYER_ID", "playerId");
define ("ACTION_GET_RCR_PERSONAL_ANALYZE_PARAM_SCORE_MODE", "scoreMode");
define ("ACTION_GET_RCR_PERSONAL_ANALYZE_PARAM_PERIOD_MODE", "periodMode");
define ("ACTION_GET_RCR_PERSONAL_ANALYZE_PARAM_YEAR", "year");
define ("ACTION_GET_RCR_PERSONAL_ANALYZE_PARAM_TRIMESTER", "trimester");
define ("ACTION_GET_RCR_PERSONAL_ANALYZE_PARAM_MONTH", "month");
define ("ACTION_GET_RCR_PERSONAL_ANALYZE_PARAM_DAY", "day");

define ("ACTION_GET_RCR_SCORE_ANALYZE", "getRCRScoreAnalyze");
define ("ACTION_GET_RCR_SCORE_ANALYZE_PARAM_TOURNAMENT_ID", "tournamentId");
define ("ACTION_GET_RCR_SCORE_ANALYZE_PARAM_PERIOD_MODE", "periodMode");
define ("ACTION_GET_RCR_SCORE_ANALYZE_PARAM_YEAR", "year");
define ("ACTION_GET_RCR_SCORE_ANALYZE_PARAM_TRIMESTER", "trimester");
define ("ACTION_GET_RCR_SCORE_ANALYZE_PARAM_MONTH", "month");
define ("ACTION_GET_RCR_SCORE_ANALYZE_PARAM_DAY", "day");
